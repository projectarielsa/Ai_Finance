            ...
            <div class="glass-card p-5 relative overflow-hidden">
                ...
                <div class="relative">
                    ...
                    <div class="flex items-end gap-2 mb-3">
                        ...
                        <span class="text-5xl font-bold {{ $scoreColor }}">
                            {{ $healthScoreValue }}
                        </span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="rounded-2xl bg-dark-700/30 border border-white/5 p-5">
                    ...
                    <h4 class="text-xl font-bold text-white">
                        Rp {{ number_format($prediction['predicted_balance'] ?? 0,0,',','.') }}
                    </h4>
                ...
                <div class="rounded-2xl bg-dark-700/30 border border-white/5 p-5">
                    ...
                    <h4 class="text-xl font-bold text-red-400">
                        Rp {{ number_format($prediction['daily_average_expense'] ?? 0,0,',','.') }}
                    </h4>
            ...
            <div class="mt-5 p-5 rounded-2xl bg-primary-500/5 border border-primary-500/10">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-dark-200 text-sm leading-relaxed">
                            {{ $prediction['message'] ?? 'AI sedang menganalisa pola transaksi Anda.' }}
                        </p>
