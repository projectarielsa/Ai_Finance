        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-18 md:h-20">
                ...
                <a href="/" class="flex items-center gap-3 group">
                    <img src="{{ asset('img/logo.svg') }}" alt="Finance AI" class="w-9 h-9 group-hover:scale-110 transition-transform">
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ route('login') }}" class="hidden sm:inline-flex text-slate-300 hover:text-white text-sm font-medium transition-colors">Masuk</a>
                    <a href="{{ route('register') }}" class="inline-flex items-center px-5 py-2.5 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 text-white text-sm font-semibold hover:from-blue-600 hover:to-purple-700 transition-all shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30 hover:scale-105">
                        Mulai Gratis
                    </a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-10">
                <div class="col-span-1 md:col-span-2">
                    <div class="flex items-center gap-3 mb-5">
                        <img src="{{ asset('img/logo.svg') }}" alt="Finance AI" class="w-9 h-9">
                    ...
                    <div class="flex items-center gap-4 mt-6">
                        <a href="https://t.me/{{ config('services.telegram.bot_username', 'FinanceAIBot') }}" target="_blank" class="w-9 h-9 rounded-lg bg-slate-800 border border-slate-700 flex items-center justify-center text-slate-400 hover:text-blue-400 hover:border-blue-500/30 transition-all">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="{{ route('register') }}" class="text-slate-400 hover:text-white text-sm transition-colors">Daftar Gratis</a></li>
                    </ul>
                </div>
            </div>
