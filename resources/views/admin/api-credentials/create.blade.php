    ...
    <div class="glass-card p-6">
        ...
        <form method="POST" action="{{ route('admin.api-credentials.store') }}" class="space-y-4">
            ...
            <div class="form-group">
                ...
                <input type="url" name="endpoint_url" value="{{ old('endpoint_url','https://api.groq.com/openai/v1') }}" class="input-field" placeholder="https://api.groq.com/openai/v1">
            </div>

            <div class="form-group">
                <label class="input-label">Model (Text)</label>
                <input type="text" name="model" value="{{ old('model','llama-3.3-70b-versatile') }}" class="input-field" placeholder="llama-3.3-70b-versatile">
