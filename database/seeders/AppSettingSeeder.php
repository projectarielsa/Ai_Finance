...
class AppSettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'ai_pending_if_low_confidence','value' => '1',               'type' => 'boolean', 'group' => 'ai', 'label' => 'Set to Pending if AI Confidence Low', 'is_public' => false],
            ['key' => 'whatsapp_enabled',        'value' => '1',                   'type' => 'boolean', 'group' => 'whatsapp', 'label' => 'Enable WhatsApp Integration', 'is_public' => false],
            ['key' => 'whatsapp_auto_reply',     'value' => '1',                   'type' => 'boolean', 'group' => 'whatsapp', 'label' => 'Enable Auto Reply', 'is_public' => false],
