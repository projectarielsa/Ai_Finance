        ...
        <div class="stat-card group">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-white mt-1">Rp <?php echo e(number_format($totalBalance,0,',','.')); ?></p>
                    <p class="text-dark-500 text-xs mt-1"><?php echo e($wallets->count()); ?> wallet aktif</p>
                </div>
        ...
        <div class="stat-card group">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-400 mt-1">Rp <?php echo e(number_format($monthlyIncome,0,',','.')); ?></p>
                    <p class="text-dark-500 text-xs mt-1"><?php echo e(now()->format('F Y')); ?></p>
                </div>
        ...
        <div class="stat-card group">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-red-400 mt-1">Rp <?php echo e(number_format($monthlyExpense,0,',','.')); ?></p>
                    <p class="text-dark-500 text-xs mt-1"><?php echo e(now()->format('F Y')); ?></p>
                </div>
        ...
        <div class="stat-card group">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-dark-500 text-xs mt-1"><?php echo e($netCashflow >= 0 ? '📈 Positif' : '📉 Negatif'); ?></p>
                </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div class="space-y-4">
            ...
            <div class="glass-card p-5 border border-primary-500/20 bg-primary-500/5">
                ...
                <p class="text-dark-200 text-sm leading-relaxed"><?php echo e($aiInsight); ?></p>
            </div>
            ...
            <div class="glass-card p-5">
                ...
                <div class="space-y-2.5">
                    <?php $__empty_1 = true; $__currentLoopData = $topCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $tc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2.5">
                            <span class="text-dark-400 text-xs w-4"><?php echo e($i+1); ?>.</span>
                            <span class="text-dark-200 text-sm"><?php echo e($tc->category?->name ?? 'Lainnya'); ?></span>
                        </div>
                        <span class="text-red-400 text-sm font-medium">Rp<?php echo e(number_format($tc->total,0,',','.')); ?></span>
                    </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div class="glass-card p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="<?php echo e(route('wallets.index')); ?>" class="text-primary-400 text-xs hover:text-primary-300">Lihat semua →</a>
            </div>
            <div class="space-y-3">
                <?php $__currentLoopData = $wallets->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wallet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-center justify-between p-3 rounded-xl bg-dark-700/30 hover:bg-dark-700/50 transition-colors">
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-lg flex items-center justify-center text-lg font-bold" style="background: <?php echo e($wallet->color); ?>22; color: <?php echo e($wallet->color); ?>">
                            <?php echo e(substr($wallet->name,0,1)); ?>

                        </div>
                        <div>
                            <p class="text-sm font-medium text-white"><?php echo e($wallet->name); ?></p>
                            <p class="text-xs text-dark-400"><?php echo e(ucfirst(str_replace('_',' ', $wallet->type))); ?></p>
                        </div>
                    </div>
                    <div class="text-right">
                        <p class="text-sm font-semibold text-white">Rp <?php echo e(number_format($wallet->balance,0,',','.')); ?></p>
                    </div>
                </div>
                ...
                <div class="text-center py-4">
                    ...
                    <a href="<?php echo e(route('wallets.create')); ?>" class="text-primary-400 text-xs hover:text-primary-300">+ Tambah wallet</a>
                </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="glass-card p-6 xl:col-span-2">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="<?php echo e(route('transactions.index')); ?>" class="text-primary-400 text-xs hover:text-primary-300">Lihat semua →</a>
            </div>
            <div class="space-y-2">
                ...
                <div class="flex items-center justify-between p-3 rounded-xl hover:bg-dark-700/20 transition-colors group">
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0
                            <?php echo e($tx->type === 'income' ? 'bg-green-500/15 text-green-400' : ($tx->type === 'expense' ? 'bg-red-500/15 text-red-400' : 'bg-blue-500/15 text-blue-400')); ?>">
                            <?php echo e($tx->type === 'income' ? '↑' : ($tx->type === 'transfer' ? '⇄' : '↓')); ?>

                        </div>
                        <div class="min-w-0">
                            <p class="text-sm font-medium text-white truncate max-w-[200px]"><?php echo e($tx->description ?? $tx->category?->name ?? 'Transaksi'); ?></p>
                            <div class="flex items-center gap-2 mt-0.5">
                                <span class="text-xs text-dark-400"><?php echo e($tx->wallet->name); ?></span>
                                <?php if($tx->category): ?><span class="text-dark-600">·</span><span class="text-xs text-dark-500"><?php echo e($tx->category->name); ?></span><?php endif; ?>
                            </div>
                        </div>
                    </div>
                    <div class="text-right flex-shrink-0">
                        <p class="text-sm font-semibold <?php echo e($tx->type === 'income' ? 'text-green-400' : ($tx->type === 'expense' ? 'text-red-400' : 'text-blue-400')); ?>">
                            <?php echo e($tx->type === 'income' ? '+' : ($tx->type === 'expense' ? '-' : '')); ?>Rp <?php echo e(number_format($tx->amount,0,',','.')); ?>

                        </p>
                        <p class="text-xs text-dark-500"><?php echo e($tx->transaction_date->format('d M')); ?></p>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="text-center py-8">
                    ...
                    <a href="<?php echo e(route('transactions.create')); ?>" class="text-primary-400 text-xs hover:text-primary-300">+ Tambah transaksi pertama</a>
                </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/arielsa/projects/Ai_Finance/resources/views/dashboard/index.blade.php ENDPATH**/ ?>