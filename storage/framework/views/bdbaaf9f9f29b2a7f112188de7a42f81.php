<?php $__env->startSection('title', 'Tambah API Credential'); ?>
<?php $__env->startSection('page-title', 'Tambah API Credential'); ?>
...
<div class="max-w-xl mx-auto animate-fade-in">
    <div class="glass-card p-6">
        ...
        <form method="POST" action="<?php echo e(route('admin.api-credentials.store')); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>

            <div class="form-group">
                <label class="input-label">Nama *</label>
                <input type="text" name="name" value="<?php echo e(old('name')); ?>" class="input-field" placeholder="Contoh: Grok AI Production" required>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="key_name" value="<?php echo e(old('key_name','api_key')); ?>" class="input-field" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="relative" x-data="{ show: false }">
                    <input :type="show?'text':'password'" name="key_value" class="input-field pr-11" placeholder="gsk_xxxxxxxxxxxxxxxxxxxx" required>
            ...
            <div class="form-group">
                ...
                <input type="url" name="endpoint_url" value="<?php echo e(old('endpoint_url','https://api.groq.com/openai/v1')); ?>" class="input-field" placeholder="https://api.groq.com/openai/v1">
            </div>

            <div class="form-group">
                <label class="input-label">Model (Text)</label>
                <input type="text" name="model" value="<?php echo e(old('model','llama-3.3-70b-versatile')); ?>" class="input-field" placeholder="llama-3.3-70b-versatile">
                <p class="text-xs text-dark-500 mt-1">Model utama untuk parsing teks transaksi & chat</p>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/arielsa/projects/Ai_Finance/resources/views/admin/api-credentials/create.blade.php ENDPATH**/ ?>