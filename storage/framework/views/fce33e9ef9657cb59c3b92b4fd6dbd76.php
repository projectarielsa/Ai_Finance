...
<form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4">
    ...
    <div class="form-group">
        ...
        <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="input-field" placeholder="email@example.com" required autofocus>
    </div>
    <div class="form-group">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-primary-400 hover:text-primary-300">Lupa password?</a>
    </div>
...
<p class="text-center text-dark-400 text-sm mt-5">
    Belum punya akun? <a href="<?php echo e(route('register')); ?>" class="text-primary-400 hover:text-primary-300 font-medium">Daftar sekarang</a>
</p>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/finance.arielsa.site/resources/views/auth/login.blade.php ENDPATH**/ ?>