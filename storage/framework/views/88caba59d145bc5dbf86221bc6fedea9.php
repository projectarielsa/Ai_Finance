...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> — <?php echo e(config('app.name', 'Finance AI')); ?></title>
    ...
    <aside
        ...
        <div class="px-4 py-4 border-b border-dark-700/30">
            <div class="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-dark-800/50">
                <img src="<?php echo e(auth()->user()->avatar_url); ?>" alt="avatar" class="w-9 h-9 rounded-full object-cover ring-2 ring-primary-500/30">
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-semibold text-white truncate"><?php echo e(auth()->user()->name); ?></p>
                    <p class="text-xs text-dark-400 truncate"><?php echo e(auth()->user()->email); ?></p>
                </div>
            </div>
        </div>
        ...
        <nav class="flex-1 overflow-y-auto px-4 py-4 space-y-1">
            ...
            <a href="<?php echo e(route('wallets.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('wallets.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('budgets.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('budgets.*') ? 'active' : ''); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                <span>Budget</span>
            </a>

            <a href="<?php echo e(route('goals.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('goals.*') ? 'active' : ''); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z"/></svg>
                <span>Tujuan Keuangan</span>
            </a>

            <a href="<?php echo e(route('recurring.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('recurring.*') ? 'active' : ''); ?>">
        ...
        <div class="px-4 py-4 border-t border-dark-700/30 space-y-1">
            <a href="https://t.me/<?php echo e(config('services.telegram.bot_username', 'FinanceAIBot')); ?>" target="_blank" class="sidebar-link text-blue-400 hover:text-blue-300 hover:bg-blue-500/10">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="flex items-center justify-between px-6 py-4 border-b border-dark-700/30 bg-dark-900/80 backdrop-blur-md">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-white font-semibold text-lg leading-none"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h1>
                    <?php if (! empty(trim($__env->yieldContent('page-subtitle')))): ?><p class="text-dark-400 text-sm mt-0.5"><?php echo $__env->yieldContent('page-subtitle'); ?></p><?php endif; ?>
                </div>
            </div>
            <div class="flex items-center gap-3">
                <?php echo $__env->yieldContent('header-actions'); ?>
                <a href="<?php echo e(route('transactions.create')); ?>" class="btn-primary text-sm">
...
<?php /**PATH /www/wwwroot/finance.arielsa.site/resources/views/layouts/app.blade.php ENDPATH**/ ?>