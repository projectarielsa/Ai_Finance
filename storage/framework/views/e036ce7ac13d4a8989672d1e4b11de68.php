...
<?php $__env->startSection('page-subtitle', 'Kelola informasi akun dan preferensi Anda'); ?>
...
<div class="max-w-2xl mx-auto space-y-5 animate-fade-in">
    ...
    <div class="glass-card p-6">
        ...
        <form method="POST" action="<?php echo e(route('profile.update')); ?>" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="flex items-center gap-4 mb-4">
                <img src="<?php echo e($user->avatar_url); ?>" alt="avatar" class="w-16 h-16 rounded-2xl object-cover ring-2 ring-primary-500/30">
                <div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phone" value="<?php echo e(old('phone',$user->phone)); ?>" class="input-field" placeholder="08123456789">
                </div>
                <div class="form-group">
                    <label class="input-label">Timezone</label>
                    <select name="timezone" class="input-field">
                        <option value="Asia/Jakarta" <?php echo e($user->timezone=='Asia/Jakarta'?'selected':''); ?>>WIB (Jakarta)</option>
                        <option value="Asia/Makassar" <?php echo e($user->timezone=='Asia/Makassar'?'selected':''); ?>>WITA (Makassar)</option>
                        <option value="Asia/Jayapura" <?php echo e($user->timezone=='Asia/Jayapura'?'selected':''); ?>>WIT (Jayapura)</option>
                    </select>
                </div>
                <div class="form-group">
                    <label class="input-label">Peringatan Saldo Minimum (Rp)</label>
                    <input type="number" name="minimum_balance_warning" value="<?php echo e(old('minimum_balance_warning',$user->minimum_balance_warning)); ?>" class="input-field" min="0">
                </div>
                <div class="col-span-2">
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="telegram_notifications" value="1" <?php echo e($user->telegram_notifications ? 'checked' : ''); ?> class="w-4 h-4 rounded border-dark-600 bg-dark-800 text-primary-500">
                        <div>
    ...
    <div class="glass-card p-5">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-dark-400 text-sm">Role: <span class="text-white font-medium"><?php echo e(ucfirst($user->role)); ?></span></p>
                <p class="text-dark-400 text-sm mt-0.5">Member sejak: <span class="text-white font-medium"><?php echo e($user->created_at->format('d M Y')); ?></span></p>
            </div>
            <?php if($user->phone): ?>
            <div class="text-right">
                <p class="text-dark-400 text-xs">Nomor telepon</p>
                <p class="text-white text-sm font-medium"><?php echo e($user->phone); ?></p>
            </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="glass-card p-6">
        ...
        <div class="flex items-center gap-3 p-3 rounded-xl bg-green-500/10 border border-green-500/20 mb-4">
            ...
            <div>
                ...
                <?php if($user->telegram_username): ?><p class="text-dark-400 text-xs"><?php echo e('@'); ?><?php echo e($user->telegram_username); ?></p><?php endif; ?>
            </div>
        </div>
        <?php else: ?>
        ...
        <ol class="text-dark-300 text-sm space-y-3 list-decimal list-inside mb-4">
            <li>Buka bot Telegram:
                <a href="https://t.me/<?php echo e(config('services.telegram.bot_username', 'FinanceAIBot')); ?>" target="_blank" class="inline-flex items-center gap-1 text-primary-400 font-medium hover:text-primary-300 transition-colors">
                    ...
                    <?php echo e('@'); ?><?php echo e(config('services.telegram.bot_username', 'FinanceAIBot')); ?>

                </a>
            </li>
            <li>Kirim perintah ini ke bot:
                <code class="text-xs bg-dark-700 text-blue-300 px-2 py-1 rounded inline-block mt-1">/link <?php echo e($user->email); ?></code>
            </li>
            <li>Selesai! Bot akan otomatis terhubung ke akun Anda</li>
        </ol>

        <a href="https://t.me/<?php echo e(config('services.telegram.bot_username', 'FinanceAIBot')); ?>" target="_blank" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-blue-500/10 border border-blue-500/20 text-blue-400 text-sm font-medium hover:bg-blue-500/20 hover:text-blue-300 transition-all">
            ...
            <div class="p-4 rounded-xl bg-dark-800/40 border border-dark-600/30 space-y-3">
                <div class="flex items-start justify-between gap-4">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer flex-shrink-0 mt-0.5">
                        <input type="checkbox" name="daily_reminder_enabled" value="1"
                               <?php echo e($user->daily_reminder_enabled ? 'checked' : ''); ?>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <select name="daily_reminder_time" class="input-field py-1.5 text-sm w-32">
                        <?php $__currentLoopData = ['07:00','08:00','09:00','10:00','11:00','12:00','13:00','14:00','15:00','16:00','17:00','18:00','19:00','20:00','21:00','22:00']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($t); ?>" <?php echo e(($user->daily_reminder_time ?? '21:00') === $t ? 'selected' : ''); ?>>
                            <?php echo e($t); ?> WIB
                        </option>
                ...
                <div class="flex items-start justify-between gap-4">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer flex-shrink-0 mt-0.5">
                        <input type="checkbox" name="weekly_summary_enabled" value="1"
                               <?php echo e($user->weekly_summary_enabled ? 'checked' : ''); ?>
                ...
                <div class="flex items-start justify-between gap-4">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer flex-shrink-0 mt-0.5">
                        <input type="checkbox" name="big_transaction_alert_enabled" value="1"
                               <?php echo e($user->big_transaction_alert_enabled ? 'checked' : ''); ?>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="relative flex-1 max-w-[180px]">
                        ...
                        <input type="number" name="big_transaction_threshold"
                               value="<?php echo e(old('big_transaction_threshold', (int)$user->big_transaction_threshold)); ?>"
    ...
    <div class="glass-card p-6">
        <div class="flex items-center gap-3 mb-5">
            <div class="w-9 h-9 rounded-xl <?php echo e($user->two_factor_enabled ? 'bg-green-500/15 text-green-400' : 'bg-dark-700/50 text-dark-400'); ?> flex items-center justify-center text-lg">
                🔐
            </div>
            <div>
        ...
        <div class="p-4 rounded-xl bg-green-500/10 border border-green-500/20 mb-5">
            <div class="flex items-start gap-3">
                <span class="text-green-400 text-lg mt-0.5">✅</span>
                <div>
                    <p class="text-green-300 text-sm font-medium">2FA sedang aktif</p>
                    <p class="text-dark-400 text-xs mt-1">Setiap login membutuhkan kode OTP 6 digit yang dikirim ke Telegram Anda
                        <?php if($user->telegram_username): ?>
                            (<span class="text-primary-400"><?php echo e('@'); ?><?php echo e($user->telegram_username); ?></span>)
                        <?php endif; ?>
                    </p>
                </div>
            </div>
        ...
        <form method="POST" action="<?php echo e(route('profile.2fa.disable')); ?>"
              onsubmit="return confirm('Nonaktifkan 2FA? Login akan lebih rentan tanpa verifikasi tambahan.')" x-data>
            <?php echo csrf_field(); ?>
        ...
        <?php if(!$user->telegram_id): ?>
        <div class="p-4 rounded-xl bg-yellow-500/10 border border-yellow-500/20 mb-5">
            <div class="flex items-start gap-3">
                <span class="text-yellow-400 text-lg mt-0.5">⚠️</span>
                <div>
                    <p class="text-yellow-300 text-sm font-medium">Telegram belum terhubung</p>
                    <p class="text-dark-400 text-xs mt-1">2FA membutuhkan koneksi Telegram. Hubungkan terlebih dahulu di bagian atas.</p>
                </div>
            </div>
        </div>
        ...
        <?php else: ?>
        <div class="p-4 rounded-xl bg-dark-800/50 border border-dark-600/30 mb-5">
            <p class="text-white text-sm font-medium mb-3">Cara kerja 2FA:</p>
            <div class="space-y-2">
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-dark-300 text-xs">Masukkan email & password seperti biasa</p>
                </div>
                <div class="flex items-center gap-3">
                    <div class="w-6 h-6 rounded-full bg-purple-500/20 text-purple-400 flex items-center justify-center text-xs font-bold flex-shrink-0">2</div>
                    <p class="text-dark-300 text-xs">Bot Telegram kirim kode OTP 6 digit</p>
                </div>
                <div class="flex items-center gap-3">
                    <div class="w-6 h-6 rounded-full bg-green-500/20 text-green-400 flex items-center justify-center text-xs font-bold flex-shrink-0">3</div>
                    <p class="text-dark-300 text-xs">Masukkan kode OTP untuk menyelesaikan login</p>
                </div>
            </div>
            <div class="mt-3 pt-3 border-t border-dark-600/30">
                <p class="text-dark-500 text-xs">OTP dikirim ke:
                    <span class="text-primary-400 font-medium">
                        <?php if($user->telegram_username): ?>
                            <?php echo e('@'); ?><?php echo e($user->telegram_username); ?>

                        <?php else: ?>
                            Telegram ID <?php echo e($user->telegram_id); ?>
        ...
        <form method="POST" action="<?php echo e(route('profile.2fa.enable')); ?>">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/finance.arielsa.site/resources/views/profile/edit.blade.php ENDPATH**/ ?>